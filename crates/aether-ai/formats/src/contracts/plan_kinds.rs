...
pub const DOUBAO_VIDEO_CREATE_SYNC_PLAN_KIND: &str = "doubao_video_create_sync";
pub const DOUBAO_VIDEO_DELETE_SYNC_PLAN_KIND: &str = "doubao_video_delete_sync";
pub const DOUBAO_VIDEO_CONTENT_PLAN_KIND: &str = "doubao_video_content";
