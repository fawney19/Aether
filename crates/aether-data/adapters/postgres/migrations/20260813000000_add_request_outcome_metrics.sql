-- Canonical request outcome metrics. Existing rows intentionally keep the in-flight/default
-- classification; this test/development migration performs no historical data backfill.
ALTER TABLE public.usage
  ADD COLUMN IF NOT EXISTS outcome_class character varying(32) DEFAULT 'in_flight' NOT NULL,
  ADD COLUMN IF NOT EXISTS sla_eligible boolean DEFAULT FALSE NOT NULL;

ALTER TABLE public.provider_api_keys
  ADD COLUMN IF NOT EXISTS sla_eligible_count bigint DEFAULT 0 NOT NULL,
  ADD COLUMN IF NOT EXISTS user_error_count bigint DEFAULT 0 NOT NULL;

ALTER TABLE public.usage_counter_deltas
  ADD COLUMN IF NOT EXISTS sla_eligible_count_delta bigint DEFAULT 0 NOT NULL,
  ADD COLUMN IF NOT EXISTS user_error_count_delta bigint DEFAULT 0 NOT NULL;

ALTER TABLE public.stats_hourly
  ADD COLUMN IF NOT EXISTS sla_eligible_requests bigint DEFAULT 0 NOT NULL,
  ADD COLUMN IF NOT EXISTS user_error_requests bigint DEFAULT 0 NOT NULL;
...
ALTER TABLE public.stats_summary
  ADD COLUMN IF NOT EXISTS all_time_sla_eligible_requests bigint DEFAULT 0 NOT NULL,
  ADD COLUMN IF NOT EXISTS all_time_user_error_requests bigint DEFAULT 0 NOT NULL;
...
SELECT
  ...
  usage_rows.outcome_class,
  usage_rows.sla_eligible
...
COMMENT ON COLUMN public.usage_billing_facts.outcome_class IS
  'Canonical request outcome classification: success, user_error, service_error, cancelled, or in_flight.';

COMMENT ON COLUMN public.usage_billing_facts.sla_eligible IS
  'Whether this request is included in SLA and success-rate denominators.';
