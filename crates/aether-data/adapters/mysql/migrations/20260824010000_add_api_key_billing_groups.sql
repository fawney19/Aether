ALTER TABLE user_groups
    ADD COLUMN sell_rate_multiplier DOUBLE NOT NULL DEFAULT 1,
    ADD CONSTRAINT user_groups_sell_rate_multiplier_check
        CHECK (sell_rate_multiplier >= 0 AND sell_rate_multiplier <= 100);

ALTER TABLE api_keys ADD COLUMN group_id VARCHAR(64) NULL;
