...
CREATE TABLE IF NOT EXISTS `usage` (
    ...
    `outcome_class` VARCHAR(32) NOT NULL DEFAULT 'in_flight',
    `sla_eligible` TINYINT(1) NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS usage_counter_deltas (
    ...
    `sla_eligible_count_delta` BIGINT NOT NULL DEFAULT 0,
    `error_count_delta` BIGINT NOT NULL DEFAULT 0,
    `user_error_count_delta` BIGINT NOT NULL DEFAULT 0,
