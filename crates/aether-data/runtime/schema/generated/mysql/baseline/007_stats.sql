...
CREATE TABLE IF NOT EXISTS stats_hourly (
    ...
    `sla_eligible_requests` BIGINT NOT NULL DEFAULT 0,
    `user_error_requests` BIGINT NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS stats_summary (
    ...
    `all_time_sla_eligible_requests` BIGINT NOT NULL DEFAULT 0,
    `all_time_user_error_requests` BIGINT NOT NULL DEFAULT 0,
