...
CREATE TABLE IF NOT EXISTS "usage" (
    ...
    outcome_class TEXT NOT NULL DEFAULT 'in_flight',
    sla_eligible INTEGER NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS usage_counter_deltas (
    ...
    sla_eligible_count_delta INTEGER NOT NULL DEFAULT 0,
    error_count_delta INTEGER NOT NULL DEFAULT 0,
    user_error_count_delta INTEGER NOT NULL DEFAULT 0,
