...
CREATE INDEX IF NOT EXISTS idx_webhook_endpoints_updated ON webhook_endpoints (updated_at_unix_secs);
...
CREATE INDEX IF NOT EXISTS idx_webhook_deliveries_endpoint_created ON webhook_deliveries (endpoint_id, created_at_unix_secs);
CREATE INDEX IF NOT EXISTS idx_webhook_deliveries_status_next ON webhook_deliveries (status, next_attempt_at_unix_secs);
CREATE INDEX IF NOT EXISTS idx_webhook_deliveries_event ON webhook_deliveries (event_type, event_id);
CREATE INDEX IF NOT EXISTS idx_webhook_deliveries_lease ON webhook_deliveries (lease_owner, lease_expires_at_unix_secs);
...
CREATE INDEX IF NOT EXISTS idx_webhook_attempts_delivery_created ON webhook_delivery_attempts (delivery_id, started_at_unix_secs);
CREATE INDEX IF NOT EXISTS idx_webhook_attempts_status ON webhook_delivery_attempts (status, started_at_unix_secs);
