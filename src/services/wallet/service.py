...
class WalletService:
    ...
    def apply_usage_charge(
        ...
        *,
        ...
        locked_wallet = db.query(Wallet).filter(Wallet.id == wallet.id).with_for_update().one_or_none()
        ...
        if cls.is_unlimited_wallet(locked_wallet):
            ...
            locked_wallet.version = int(locked_wallet.version or 0) + 1
    ...
    def create_wallet_transaction(
        ...
        *,
        ...
        if reason_code == REASON_REFUND_OUT and delta < Decimal("0") and after_recharge < Decimal("0"):
    ...
    def admin_adjust_balance(
        ...
        *,
        ...
        def consume_positive_bucket(balance: Decimal, to_consume: Decimal) -> tuple[Decimal, Decimal]:
    ...
    def create_refund_request(
        ...
        *,
        ...
        refundable_balance = cls.get_refundable_balance_value(wallet)
    ...
    def move_refund_to_processing(
        ...
        *,
        ...
        locked_refund = (
            db.query(RefundRequest).filter(RefundRequest.id == refund.id).with_for_update().one_or_none()
        )
        ...
        if payment_order is not None:
            ...
            payment_order.refunded_amount_usd = to_money_decimal(payment_order.refunded_amount_usd) + delta
