...
fn classifies_admin_payments_redeem_code_routes_as_admin_proxy_route() {
    ...
    assert_eq!(list_batches.route_family.as_deref(), Some("payments_manage"));
    assert_eq!(
    ...
    let create_batch = classify_control_route(&http::Method::POST, &create_batch_uri, &headers)
        .expect("route should classify");
    assert_eq!(create_batch.route_family.as_deref(), Some("payments_manage"));
    assert_eq!(
    ...
    let disable_code = classify_control_route(&http::Method::POST, &disable_code_uri, &headers)
        .expect("route should classify");
    assert_eq!(disable_code.route_family.as_deref(), Some("payments_manage"));
    assert_eq!(disable_code.route_kind.as_deref(), Some("disable_redeem_code"));
    ...
    let delete_batch = classify_control_route(&http::Method::POST, &delete_batch_uri, &headers)
        .expect("route should classify");
    assert_eq!(delete_batch.route_family.as_deref(), Some("payments_manage"));
    assert_eq!(
