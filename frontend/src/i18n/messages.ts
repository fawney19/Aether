...
const legacyPhraseEnglishMessages: Array<[string, string]> = [
  ...
  ['精简 Base64 图片', 'Compact Base64 images'],
  ['将 data:image/...;base64 图片替换为包含原始大小的占位符', 'Replace data:image/...;base64 images with placeholders that show their original size'],
  ['Body 大小上限（KB）', 'Body size limit (KB)'],
  ['每个请求/响应 Body 独立限制，0 表示不限制', 'Limit each request/response body independently; 0 means unlimited'],
