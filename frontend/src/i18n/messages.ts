export const messages = {
  'zh-CN': {
    ...
    'providers.quota.localEffective': '本地生效额度',
    'providers.quota.upstreamWindows': 'Sub2API 上游套餐窗口',
    'providers.quota.mappedLocally': '映射到本地',
    'providers.quota.remoteConfirmed': '上游已确认',
    'providers.quota.syncLocalDelta': '同步期间本地增量',
  ...
  'en-US': {
    ...
    'providers.quota.localEffective': 'Locally enforced quota',
    'providers.quota.upstreamWindows': 'Sub2API upstream subscription windows',
    'providers.quota.mappedLocally': 'Mapped locally',
    'providers.quota.remoteConfirmed': 'Confirmed upstream',
    'providers.quota.syncLocalDelta': 'Local delta during sync',
