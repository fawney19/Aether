...
const sourceMonitor = computed<HealthRelatedMonitor | null>(() => {
  ...
  return {
    ...
    sla_eligible_count: source.slaEligibleCount ?? undefined,
    success_count: source.successCount,
    failed_count: source.failedCount,
    service_error_count: source.serviceErrorCount ?? source.failedCount,
    user_error_count: source.userErrorCount ?? undefined,
